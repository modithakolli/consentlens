const COMPANY_RULES = [
  ...
  { company: "Microsoft", purpose: "Identity, ads, productivity services", hq: "United States", reputation: "Broad ecosystem services", domains: ["login.microsoftonline.com", "login.live.com", "bing.com", "clarity.ms"] },
